...
const allTasks = [
    {
        ...
        generate: function() {
            ...
            while (true) { // Добавляем цикл для повторных попыток, если генерация не удастся
                try {
                    ...
                    if (p_x_2_options.length === 0) continue; // Если нет вариантов, начать генерацию заново
                    ...
                    // Если генерация не удалась (например, choice от пустого массива), пробуем снова
                    continue;
                }
            }
        },
